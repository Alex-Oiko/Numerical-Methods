...
%%% option and the delta of the expected value for the geometric asian call
%%% option
...
function [geometric_asian_expected_asian, geometric_asian_expected_delta] = geometricAsianExpected(S0,K,sigma,r,T,n)
    ...
    %the expected value of the geometric asian call option
    ...
    %the expected delta value of the geometric asian call option
